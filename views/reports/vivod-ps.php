...
$this->title = 'Доходы по выводу по ПС';
?>
    
<h4 class="text-center">Доходы по выводу в разрезе платежных систем</h4>
...
<?php 
    ...
    $table = '<table class="table table-striped table-bordered"><tr><th>Валюта ПС</th><th>Платежная система</th><th>Списано с кассы</th>
        <th>Списано в ПС</th><th>Получено мерчантом</th><th>Комиссия ПС</th><th>Конвертация</th><th>Доход</th><th>Прибыль</th></tr>';	
