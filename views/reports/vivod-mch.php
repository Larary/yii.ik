...
$this->title = 'Доходы по выводу по мерчантам';
?>
    
<h4 class="text-center">Доходы по выводу в разрезе мерчантов</h4>
...
<?php 
    ...
    $table = '<table class="table table-striped table-bordered"><tr><th>Валюта</th><th>ID мерч.</th><th>Мерчант</th>
        <th>Списано с кассы</th><th>Списано в ПС</th><th>Комиссия ПС</th><th>Конв. комиссия</th><th>Доход</th><th>Прибыль</th></tr>';	
